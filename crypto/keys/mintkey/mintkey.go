...
const (
	blockTypePrivKey = "HTDF PRIVATE KEY"
	blockTypeKeyInfo = "HTDF KEY INFO"
	blockTypePubKey  = "HTDF PUBLIC KEY"
)
...
// to hscli keys in future startups / or the attacker must get access
