...
func NewProtocolV1(version uint64, log log.Logger, pk sdk.ProtocolKeeper, invCheckPeriod uint, config *cfg.InstrumentationConfig) *ProtocolV1 {
	p0 := ProtocolV1{
		version:        version,
		logger:         log,
		protocolKeeper: pk,
...
func (p *ProtocolV1) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	...
	v1Staking.BeginBlocker(ctx, p.StakeKeeper)
...
func (p *ProtocolV1) initFromGenesisState(ctx sdk.Context, DeliverTx sdk.DeliverTx, genesisState GenesisState) []abci.ValidatorUpdate {
