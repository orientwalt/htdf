...
func ToAppAddress(ethAddr common.Address) AccAddress {

	return AccAddress(ethAddr.Bytes())
}

func ToEthAddress(appAddr AccAddress) common.Address {
	return common.BytesToAddress(appAddr.Bytes())
}
