...
type MsgAddLiquidity struct {
	...
	ExactStandardAmt github_com_cosmos_cosmos_sdk_types.Int        `protobuf:"bytes,2,opt,name=exact_standard_amt,json=exactStandardAmt,proto3,customtype=github.com/orientwalt/htdf/types.Int" json:"exact_standard_amt" yaml:"exact_standard_amt"`
	MinLiquidity     github_com_cosmos_cosmos_sdk_types.Int        `protobuf:"bytes,3,opt,name=min_liquidity,json=minLiquidity,proto3,customtype=github.com/orientwalt/htdf/types.Int" json:"min_liquidity" yaml:"min_liquidity"`
	Deadline         int64                                         `protobuf:"varint,4,opt,name=deadline,proto3" json:"deadline,omitempty"`
	Sender           github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,5,opt,name=sender,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"sender,omitempty"`
}
...
type MsgRemoveLiquidity struct {
	...
	MinToken          github_com_cosmos_cosmos_sdk_types.Int        `protobuf:"bytes,2,opt,name=min_token,json=minToken,proto3,customtype=github.com/orientwalt/htdf/types.Int" json:"min_token" yaml:"min_token"`
	MinStandardAmt    github_com_cosmos_cosmos_sdk_types.Int        `protobuf:"bytes,3,opt,name=min_standard_amt,json=minStandardAmt,proto3,customtype=github.com/orientwalt/htdf/types.Int" json:"min_standard_amt" yaml:"min_standard_amt"`
	Deadline          int64                                         `protobuf:"varint,4,opt,name=deadline,proto3" json:"deadline,omitempty"`
	Sender            github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,5,opt,name=sender,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"sender,omitempty"`
}
...
type Input struct {
	Address github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,1,opt,name=address,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"address,omitempty"`
...
// token parameters
type Params struct {
	Fee           github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=fee,proto3,customtype=github.com/orientwalt/htdf/types.Dec" json:"fee"`
