...
import (
	context "context"
	fmt "fmt"
	types "github.com/orientwalt/htdf/codec/types"
	_ "github.com/orientwalt/htdf/types"
...
func (m *QueryTokensRequest) GetOwner() github_com_cosmos_cosmos_sdk_types.AccAddress {
	if m != nil {
		return m.Owner
	}
	return nil
...
type QueryFeesResponse struct {
	...
	IssueFee github_com_cosmos_cosmos_sdk_types.Coin `protobuf:"bytes,2,opt,name=issue_fee,json=issueFee,proto3,casttype=github.com/orientwalt/htdf/types.Coin" json:"issue_fee" yaml:"issue_fee"`
	MintFee  github_com_cosmos_cosmos_sdk_types.Coin `protobuf:"bytes,3,opt,name=mint_fee,json=mintFee,proto3,casttype=github.com/orientwalt/htdf/types.Coin" json:"mint_fee" yaml:"mint_fee"`
}
...
var fileDescriptor_ec043bcd18c4056e = []byte{
	...
	,
}
