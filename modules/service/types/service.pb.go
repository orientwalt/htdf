...
type MsgDefineService struct {
	...
	Author            github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,4,opt,name=author,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"author,omitempty"`
...
type MsgBindService struct {
	...
	Deposit     github_com_cosmos_cosmos_sdk_types.Coins      `protobuf:"bytes,3,rep,name=deposit,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"deposit"`
	...
	Owner       github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,7,opt,name=owner,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"owner,omitempty"`
}
...
type MsgSetWithdrawAddress struct {
	...
	WithdrawAddress github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,2,opt,name=withdraw_address,json=withdrawAddress,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"withdraw_address,omitempty" yaml:"withdraw_address"`
}
...
type MsgDisableServiceBinding struct {
	ServiceName string                                        `protobuf:"bytes,1,opt,name=service_name,json=serviceName,proto3" json:"service_name,omitempty" yaml:"service_name"`
	Provider    github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,2,opt,name=provider,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"provider,omitempty"`
	Owner       github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,3,opt,name=owner,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"owner,omitempty"`
}
...
type MsgCallService struct {
	ServiceName       string                                          `protobuf:"bytes,1,opt,name=service_name,json=serviceName,proto3" json:"service_name,omitempty" yaml:"service_name"`
	Providers         []github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,2,rep,name=providers,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"providers,omitempty"`
	Consumer          github_com_cosmos_cosmos_sdk_types.AccAddress   `protobuf:"bytes,3,opt,name=consumer,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"consumer,omitempty"`
	Input             string                                          `protobuf:"bytes,4,opt,name=input,proto3" json:"input,omitempty"`
	ServiceFeeCap     github_com_cosmos_cosmos_sdk_types.Coins        `protobuf:"bytes,5,rep,name=service_fee_cap,json=serviceFeeCap,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"service_fee_cap" yaml:"service_fee_cap"`
...
type MsgPauseRequestContext struct {
	...
	Consumer         github_com_cosmos_cosmos_sdk_types.AccAddress        `protobuf:"bytes,2,opt,name=consumer,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"consumer,omitempty"`
}
...
type MsgUpdateRequestContext struct {
	...
	Providers         []github_com_cosmos_cosmos_sdk_types.AccAddress      `protobuf:"bytes,2,rep,name=providers,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"providers,omitempty"`
	Consumer          github_com_cosmos_cosmos_sdk_types.AccAddress        `protobuf:"bytes,3,opt,name=consumer,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"consumer,omitempty"`
	ServiceFeeCap     github_com_cosmos_cosmos_sdk_types.Coins             `protobuf:"bytes,4,rep,name=service_fee_cap,json=serviceFeeCap,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"service_fee_cap" yaml:"service_fee_cap"`
...
type ServiceBinding struct {
	...
	Owner        github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,9,opt,name=owner,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"owner,omitempty"`
}
...
type Request struct {
	...
	Provider                   github_com_cosmos_cosmos_sdk_types.AccAddress        `protobuf:"bytes,3,opt,name=provider,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"provider,omitempty"`
	Consumer                   github_com_cosmos_cosmos_sdk_types.AccAddress        `protobuf:"bytes,4,opt,name=consumer,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"consumer,omitempty"`
	Input                      string                                               `protobuf:"bytes,5,opt,name=input,proto3" json:"input,omitempty"`
	ServiceFee                 github_com_cosmos_cosmos_sdk_types.Coins             `protobuf:"bytes,6,rep,name=service_fee,json=serviceFee,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"service_fee" yaml:"service_fee"`
	SuperMode                  bool                                                 `protobuf:"varint,7,opt,name=super_mode,json=superMode,proto3" json:"super_mode,omitempty" yaml:"super_mode"`
...
type CompactRequest struct {
	...
	Provider                   github_com_cosmos_cosmos_sdk_types.AccAddress        `protobuf:"bytes,3,opt,name=provider,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"provider,omitempty"`
	ServiceFee                 github_com_cosmos_cosmos_sdk_types.Coins             `protobuf:"bytes,4,rep,name=service_fee,json=serviceFee,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"service_fee" yaml:"service_fee"`
...
type Pricing struct {
	Price              github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,6,rep,name=price,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"price"`
...
type PromotionByTime struct {
	...
	Discount  github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=discount,proto3,customtype=github.com/orientwalt/htdf/types.Dec" json:"discount"`
}
...
type PromotionByVolume struct {
	...
	Discount github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=discount,proto3,customtype=github.com/orientwalt/htdf/types.Dec" json:"discount"`
}
...
type Params struct {
	...
	MinDeposit           github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,3,rep,name=min_deposit,json=minDeposit,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"min_deposit"`
	ServiceFeeTax        github_com_cosmos_cosmos_sdk_types.Dec   `protobuf:"bytes,4,opt,name=service_fee_tax,json=serviceFeeTax,proto3,customtype=github.com/orientwalt/htdf/types.Dec" json:"service_fee_tax" yaml:"service_fee_tax"`
	SlashFraction        github_com_cosmos_cosmos_sdk_types.Dec   `protobuf:"bytes,5,opt,name=slash_fraction,json=slashFraction,proto3,customtype=github.com/orientwalt/htdf/types.Dec" json:"slash_fraction" yaml:"slash_fraction"`
