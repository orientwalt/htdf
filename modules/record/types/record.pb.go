...
type MsgCreateRecord struct {
	...
	Creator  github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,2,opt,name=creator,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"creator,omitempty"`
}
...
type Record struct {
	...
	Creator  github_com_cosmos_cosmos_sdk_types.AccAddress        `protobuf:"bytes,3,opt,name=creator,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"creator,omitempty"`
}
