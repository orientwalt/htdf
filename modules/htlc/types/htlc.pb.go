...
type MsgCreateHTLC struct {
	Sender               github_com_cosmos_cosmos_sdk_types.AccAddress        `protobuf:"bytes,1,opt,name=sender,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"sender,omitempty"`
	To                   github_com_cosmos_cosmos_sdk_types.AccAddress        `protobuf:"bytes,2,opt,name=to,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"to,omitempty"`
