...
type MsgCreateFeed struct {
	...
	Creator           github_com_cosmos_cosmos_sdk_types.AccAddress   `protobuf:"bytes,4,opt,name=creator,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"creator,omitempty"`
	...
	Providers         []github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,6,rep,name=providers,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"providers,omitempty"`
	Input             string                                          `protobuf:"bytes,7,opt,name=input,proto3" json:"input,omitempty"`
	Timeout           int64                                           `protobuf:"varint,8,opt,name=timeout,proto3" json:"timeout,omitempty"`
	ServiceFeeCap     github_com_cosmos_cosmos_sdk_types.Coins        `protobuf:"bytes,9,rep,name=service_fee_cap,json=serviceFeeCap,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"service_fee_cap" yaml:"service_fee_cap"`
...
type MsgEditFeed struct {
	...
	Providers         []github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,4,rep,name=providers,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"providers,omitempty"`
	...
	Creator           github_com_cosmos_cosmos_sdk_types.AccAddress   `protobuf:"bytes,9,opt,name=creator,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"creator,omitempty"`
}
...
type Feed struct {
	...
	Creator          github_com_cosmos_cosmos_sdk_types.AccAddress        `protobuf:"bytes,7,opt,name=creator,proto3,casttype=github.com/orientwalt/htdf/types.AccAddress" json:"creator,omitempty"`
}
