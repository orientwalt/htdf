...
contract Test1 {
  function isSameAddress(address a, address b) public pure returns(bool){  //Simply add the two arguments and return
      if (a == b) return true;
      return false;
  }
}
...
contract OpCodes {
   ...
   function test()   public {
    ...
    // // ecrecover
    // address bz = ecTest.testEcrecover();
    // address secretSigner =  address(0x954d1a58c7abd4ac8ebe05f59191Cf718eb0cB89);
    // require(secretSigner == bz);

   }

  function test_revert() pure  public {

    //revert
    assembly{ revert(0, 0) }
  }

  function test_invalid() pure public {

    //revert
    assembly{ invalid() }
  }

  function test_stop() pure public {
    ...
    /////////// should be ok
    function test_ecrecover() public pure returns( address ){
        address  secretSigner =  address(0x954d1a58c7abd4ac8ebe05f59191Cf718eb0cB89);
