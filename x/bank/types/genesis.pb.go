...
type GenesisState struct {
	...
	Supply github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,3,rep,name=supply,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"supply"`
...
type Balance struct {
	...
	Coins github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=coins,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"coins"`
}
