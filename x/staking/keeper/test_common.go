...
func MakeTestCodec() *codec.Codec {
	...
	// cdc.RegisterConcrete(bank.MsgEthereumTx{}, "test/staking/Send", nil)
...
func CreateTestInput(t *testing.T, isCheckTx bool, initPower int64) (sdk.Context, auth.AccountKeeper, Keeper) {
	...
	keeper := NewKeeper(cdc, keyStaking, tkeyStaking, ck, pk.Subspace(DefaultParamspace), types.DefaultCodespace, NopMetrics())
