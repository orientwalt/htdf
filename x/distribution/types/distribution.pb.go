...
type Params struct {
	CommunityTax        github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=community_tax,json=communityTax,proto3,customtype=github.com/orientwalt/htdf/types.Dec" json:"community_tax" yaml:"community_tax"`
	BaseProposerReward  github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=base_proposer_reward,json=baseProposerReward,proto3,customtype=github.com/orientwalt/htdf/types.Dec" json:"base_proposer_reward" yaml:"base_proposer_reward"`
	BonusProposerReward github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=bonus_proposer_reward,json=bonusProposerReward,proto3,customtype=github.com/orientwalt/htdf/types.Dec" json:"bonus_proposer_reward" yaml:"bonus_proposer_reward"`
...
type ValidatorHistoricalRewards struct {
	CumulativeRewardRatio github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=cumulative_reward_ratio,json=cumulativeRewardRatio,proto3,castrepeated=github.com/orientwalt/htdf/types.DecCoins" json:"cumulative_reward_ratio" yaml:"cumulative_reward_ratio"`
...
type ValidatorCurrentRewards struct {
	Rewards github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=rewards,proto3,castrepeated=github.com/orientwalt/htdf/types.DecCoins" json:"rewards"`
...
type ValidatorAccumulatedCommission struct {
	Commission github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=commission,proto3,castrepeated=github.com/orientwalt/htdf/types.DecCoins" json:"commission"`
}
...
type ValidatorOutstandingRewards struct {
	Rewards github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=rewards,proto3,castrepeated=github.com/orientwalt/htdf/types.DecCoins" json:"rewards" yaml:"rewards"`
}
...
type ValidatorSlashEvent struct {
	...
	Fraction        github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=fraction,proto3,customtype=github.com/orientwalt/htdf/types.Dec" json:"fraction"`
}
...
type FeePool struct {
	CommunityPool github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=community_pool,json=communityPool,proto3,castrepeated=github.com/orientwalt/htdf/types.DecCoins" json:"community_pool" yaml:"community_pool"`
}
...
type CommunityPoolSpendProposal struct {
	...
	Amount      github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,4,rep,name=amount,proto3,castrepeated=github.com/orientwalt/htdf/types.Coins" json:"amount"`
}
...
type DelegatorStartingInfo struct {
	...
	Stake          github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=stake,proto3,customtype=github.com/orientwalt/htdf/types.Dec" json:"stake" yaml:"stake"`
...
type DelegationDelegatorReward struct {
	...
	Reward           github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=reward,proto3,castrepeated=github.com/orientwalt/htdf/types.DecCoins" json:"reward"`
}
