...
func CreateTestInputAdvanced(t *testing.T, isCheckTx bool, initPower int64,
	...
	sk := staking.NewKeeper(cdc, keyStaking, tkeyStaking, bankKeeper, pk.Subspace(staking.DefaultParamspace), staking.DefaultCodespace, stakekeeper.NopMetrics())
	...
	keeper := NewKeeper(cdc, keyDistr, pk.Subspace(DefaultParamspace), bankKeeper, sk, fck, types.DefaultCodespace, NopMetrics())
